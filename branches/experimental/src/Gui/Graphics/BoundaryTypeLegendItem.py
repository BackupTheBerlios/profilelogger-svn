...
class BoundaryTypeLegendItem(LegendItem):
    def __init__(self, parent, scene, rect, pen, font, boundaryType):
        LegendItem.__init__(self, parent, scene, rect, pen, font, boundaryType)
