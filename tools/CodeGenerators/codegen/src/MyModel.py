...
class MyModel(Model):
    ...
    def setupPythonModules(self):
        ...
        finders = self.createPythonModule('Finders')
        self.setupDataClasses(model)
        self.setupFinderClasses(finders)
    def setupFinderClasses(self, model):
        globalTmpl = TemplateFile('templates/Finders/GlobalFinder.py')
        inProjectTmpl = TemplateFile('templates/Finders/InProjectFinder.py')
        inProfileTmpl = TemplateFile('templates/Finders/InProfileFinder.py')
        inBedTmpl = TemplateFile('templates/Finders/InBedFinder.py')
        inFieldBookTmpl = TemplateFile('templates/Finders/InFieldBookFinder.py')

        model.createFinderClass('GraphicPrimitive', globalTmpl)
        model.createFinderClass('Project', globalTmpl)
        model.createFinderClass('LengthUnit', globalTmpl)        
        model.createFinderClass('Profile', inProjectTmpl)
        model.createFinderClass('ProfileColumn', inProfileTmpl)
        model.createFinderClass('ProfileInProfileColumn', inProjectTmpl)
        model.createFinderClass('Bed', inProjectTmpl)
        model.createFinderClass('Color', inProjectTmpl)
        model.createFinderClass('ColorInBed', inBedTmpl)
        model.createFinderClass('OutcropType', inProjectTmpl)
        model.createFinderClass('OutcropTypeInBed', inBedTmpl)
        model.createFinderClass('Facies', inProjectTmpl)
        model.createFinderClass('FaciesInBed', inBedTmpl)
        model.createFinderClass('Lithology', inProjectTmpl)
        model.createFinderClass('LithologyInBed', inBedTmpl)
        model.createFinderClass('TectonicUnitType', inProjectTmpl)
        model.createFinderClass('TectonicUnit', inProjectTmpl)
        model.createFinderClass('TectonicUnitInBed', inBedTmpl)
        model.createFinderClass('GrainSizeType', inProjectTmpl)
        model.createFinderClass('GrainSize', inProjectTmpl)
        model.createFinderClass('GrainSizeInBed', inBedTmpl)
        model.createFinderClass('LithologicUnitType', inProjectTmpl)
        model.createFinderClass('LithologicUnit', inProjectTmpl)
        model.createFinderClass('LithologicUnitInBed', inBedTmpl)
        model.createFinderClass('SedimentologicUnitType', inProjectTmpl)
        model.createFinderClass('SedimentologicUnit', inProjectTmpl)
        model.createFinderClass('SedimentologicUnitInBed', inBedTmpl)
        model.createFinderClass('StratigraphicUnitType', inProjectTmpl)
        model.createFinderClass('StratigraphicUnit', inProjectTmpl)
        model.createFinderClass('StratigraphicUnitInBed', inBedTmpl)
        model.createFinderClass('Fossil', inProjectTmpl)
        model.createFinderClass('FossilInBed', inBedTmpl)
        model.createFinderClass('BeddingType', inProjectTmpl)
        model.createFinderClass('BeddingTypeInBed', inBedTmpl)
        model.createFinderClass('BoundaryType', inProjectTmpl)
        model.createFinderClass('BoundaryTypeInBed', inBedTmpl)
        model.createFinderClass('SedimentStructure', inProjectTmpl)
        model.createFinderClass('SedimentStructureInBed', inBedTmpl)
        model.createFinderClass('CustomSymbol', inProjectTmpl)
        model.createFinderClass('CustomSymbolInBed', inBedTmpl)
        model.createFinderClass('BeddingType', inProjectTmpl)
        model.createFinderClass('BeddingTypeInBed', inBedTmpl)
        model.createFinderClass('FieldBook', globalTmpl)
        model.createFinderClass('FieldBookEntry', inFieldBookTmpl)
