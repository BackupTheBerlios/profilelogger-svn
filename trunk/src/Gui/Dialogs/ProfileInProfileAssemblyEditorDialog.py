...
class ProfileInProfileAssemblyEditorDialog(DatasetInProfileAssemblyEditorDialog):
    def __init__(self, parent, data):
        ...
        self.profileW.currentDatasetChanged.connect(self.baseBedW.onProfileChange)
        self.profileW.currentDatasetChanged.connect(self.topBedW.onProfileChange)

        self.profileW.setProject(self.data.profileAssembly.project)
        self.profileW.reload()

        self.baseBedW.setProfile(self.data.profile)
        self.baseBedW.reload()
        self.topBedW.setProfile(self.data.profile)
        self.topBedW.reload()
    ...
    def addCustomBedsSelector(self):
        ...
        self.baseBedW = BedItemView(self)
        self.topBedW = BedItemView(self)
