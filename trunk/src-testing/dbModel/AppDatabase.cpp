...
AppDatabase::AppDatabase(QCoreApplication* p)
...
void AppDatabase::setupSchemas()
{
  _schemaData = createSchema("data");  
}

void AppDatabase::setupSequences()
{
...
void AppDatabase::configureTables()
{
...
void AppDatabase::configureTableProjects()
{
...
void AppDatabase::configureTableLithologies()
{
...
void AppDatabase::configureTableFossils()
{
...
void AppDatabase::configureTableGrainSizeModes()
{
...
void AppDatabase::configureTableGrainSizes()
{
...
void AppDatabase::configureTableLithologicalUnitTypes()
{
...
void AppDatabase::configureTableLithologicalUnits()
{
...
void AppDatabase::configureTableFacies()
{
...
void AppDatabase::configureTableOutcropQualities()
{
...
void AppDatabase::configureTableBeddingTypes()
{
...
void AppDatabase::configureTableBoundaryTypes()
{
...
void AppDatabase::configureTableColors()
{
...
void AppDatabase::configureTableCustomSymbols()
{
...
void AppDatabase::configureTableSedimentStructures()
{
...
void AppDatabase::configureTableProfiles()
{
...
void AppDatabase::configureTableBeds()
{
...
void AppDatabase::setupForeignKeys()
{
